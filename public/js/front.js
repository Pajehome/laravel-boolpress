  ...
  method: {
    getDetail: function getDetail(slug) {
      ...
      axios.get('/api/posts/' + slug).then(function (response) {
        ...
        _this.post[index].detail = response.data;
      });
    }
  },
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
          ...
          "a",
          {
            ...
            on: {
              click: function ($event) {
                return _vm.getDetail(_vm.post.slug, _vm.index)
              },
            },
          },
        ...
        _vm._v(" "),
        _vm.post.detail
          ? _c("span", [_vm._v(_vm._s(_vm.post.detail.slug))])
          : _vm._e(),
      ],
      2
    ),
...
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // const files = require.context('./', true, /\.vue$/i)
